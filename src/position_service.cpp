 ...
 *@retval a double random value inside the interval
 */
 ...
 *@param req  the request received from the client. minimum and maximum values for both for x and y 
 *@param res  the response returned to the client (the random for x and y)
 *@retval the boolean 
 */
